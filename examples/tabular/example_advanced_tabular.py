...
"""
import sys
sys.path.insert(0, "/home/liangfc/workspace/autogluon")
...
hyperparameters = {
    'NN_TORCH': {'num_epochs': 2, 'activation': 'relu'}, # , 'dropout_prob': ag.Real(0.0, 0.5)},
...
test_data = TabularDataset('test.csv')  # another Pandas DataFrame
# test_data = test_data.head(8192)
...
print(f"elapsed (overall): {(time.time()-tic)*1000:.0f} ms")
